...
export default async function VaultPage() {
  ...
  // Error lain — misal decrypt gagal karena session key tidak cocok
  if (!result.success) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <h2 className="font-semibold text-xl text-stone-700 mb-1">Terjadi Kesalahan</h2>
